        ...
        <section className="w-screen h-screen flex flex-col gap-[20px] w-full justify-center items-center">
            ...
            <div className="flex flex-col  w-[200px] justify-center items-center">
                <form className="flex flex-col gap-[20px]" onSubmit={handleSubmit}>
                    <input className="p-2 rounded bg-[#ffffff] placeholder:text-gray-500 text-[#181818]" type="text" placeholder="Name" onChange={(e) => setName(e.target.value)} />
                    ...
                    <input className="p-2 rounded bg-[#ffffff] placeholder:text-gray-500 text-[#181818]" type="password" placeholder="Confirm Password" onChange={(e) => handlePasswordConfirm(e.target.value)} />
                    <button className="bg-[#ffffff] text-black p-2 rounded hover:bg-[#cccccc] cursor-pointer transition duration-300 ease-in-out text-center w-full" type="submit">Register</button>
                </form>
                <Link className="hover:text-blue-500 p-2 text-bold font-light" href="/auth/login">Ya tienes una cuenta?</Link>
                {errorMsg && (
